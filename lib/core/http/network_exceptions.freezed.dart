...
class _$NetworkExceptionsTearOff {
  ...
  InternalServerError internalServerError(DioError error) {
    DioError _error = error;
    return InternalServerError(_error);
  }
...
mixin _$NetworkExceptions {
  ...
  Result when<Result extends Object>({
    ...
    @required Result internalServerError(DioError error),
...
abstract class $UnauthorizedRequestCopyWith<$Res> {
  factory $UnauthorizedRequestCopyWith(UnauthorizedRequest value, $Res Function(UnauthorizedRequest) then) =
      _$UnauthorizedRequestCopyWithImpl<$Res>;
}

class _$UnauthorizedRequestCopyWithImpl<$Res> extends _$NetworkExceptionsCopyWithImpl<$Res>
...
abstract class InternalServerError implements NetworkExceptions {
  const factory InternalServerError(DioError error) = _$InternalServerError;
}
...
class _$DefaultErrorCopyWithImpl<$Res> extends _$NetworkExceptionsCopyWithImpl<$Res> implements $DefaultErrorCopyWith<$Res> {
  _$DefaultErrorCopyWithImpl(DefaultError _value, $Res Function(DefaultError) _then) : super(_value, (v) => _then(v as DefaultError));
